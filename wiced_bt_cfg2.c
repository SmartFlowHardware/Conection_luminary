...
volatile wiced_bt_cfg_settings_t app_cfg_settings2 =
{
    ...
    .device_class                        = {0x4e, 0x44, 0x4c},                                         	/**< Local device class */
    ...
    .ble_scan_cfg =						/* BLE scan settings  */
    {
        ...
        .high_duty_scan_window           = 96,//WICED_BT_CFG_DEFAULT_HIGH_DUTY_SCAN_WINDOW,					/**< High duty scan window */
        .high_duty_scan_duration         = 0,                                                          	/**< High duty scan duration in seconds (0 for infinite) */

        .low_duty_scan_interval          = 96,//WICED_BT_CFG_DEFAULT_LOW_DUTY_SCAN_INTERVAL,					/**< Low duty scan interval  */
        .low_duty_scan_window            = 96,//WICED_BT_CFG_DEFAULT_LOW_DUTY_SCAN_WINDOW,					/**< Low duty scan window */
        ...
        .high_duty_conn_duration         = 30,//0,                                                         	/**< High duty cycle connection duration in seconds (0 for infinite) */
        ...
        .low_duty_conn_duration          = 30,//0,                                                         	/**< Low duty cycle connection duration in seconds (0 for infinite) */
